...
const getNavItems = () => [
  ...
  { to: '/pos/kiosk', icon: ShoppingCart, label: 'Punto de Venta' },
  { to: '/pos/products', icon: Boxes, label: 'Productos' },
  { to: '/pos/sales', icon: ReceiptText, label: 'Ventas' },
  { to: '/pos/balances', icon: BadgeDollarSign, label: 'Saldos' },
  { to: '/attendance', icon: CalendarCheck, label: 'Asistencia' },
  { to: '/kiosk', icon: ScanLine, label: 'Kiosco Asistencia' },
