...
import { Calendar as CalendarIcon, CheckCircle2, XCircle, Filter, AlertCircle, Dumbbell } from 'lucide-react'
                    ...
                    <td className="px-6 py-4">
                      {record.member ? (
                        <div className="flex flex-col">
                          <span className="font-medium text-slate-900">{record.member.full_name}</span>
