...
export function EmptyReportState({ title, message, icon }: EmptyReportStateProps) {
  const displayTitle = title || 'Sin datos para este periodo'
  const displayMessage =
    message ||
    'No hay información disponible para el rango de fechas seleccionado. Intenta ampliar el periodo de consulta.'
  return (
