...
export function ExportPdfButton({ meta, buildContent, filename }: ExportPdfButtonProps) {
  ...
  return (
    <div className="flex flex-col items-end gap-1">
      <button
        ...
        disabled={loading}
        className="flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white text-sm font-semibold rounded-xl hover:bg-indigo-700 disabled:opacity-60 disabled:cursor-not-allowed transition-all shadow-sm hover:shadow-md cursor-pointer"
      >
