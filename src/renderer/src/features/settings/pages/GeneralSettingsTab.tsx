    ...
    <div className="w-full space-y-6 animate-fade-in">
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500">{"Ajustes regionales y opciones para la generación de reportes PDF."}</p>
        </div>
      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <Card className="p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div className="space-y-1.5">
              <label className="text-sm font-semibold text-slate-700">{"Formato de Moneda (Locale)"}</label>
              <select
        ...
        <Card className="p-6">
          <div className="flex items-center gap-2 mb-4 border-b border-slate-100 pb-4">
            ...
            <h3 className="text-lg font-bold text-slate-900">{"Personalización de Reportes (PDF)"}</h3>
          </div>
          
          <div className="grid grid-cols-1 gap-5">
            <div className="space-y-1.5">
              <label className="text-sm font-semibold text-slate-700">{"Nombre en Cabecera de Reportes"}</label>
              <input
                type="text"
                value={reportName}
              ...
              />
              <p className="text-xs text-slate-500">{"Si se deja vacío, se utilizará el Nombre Comercial del gimnasio."}</p>
            </div>

            <div className="space-y-1.5">
              <label className="text-sm font-semibold text-slate-700">{"Texto del Pie de Página"}</label>
              <textarea
                rows={2}
